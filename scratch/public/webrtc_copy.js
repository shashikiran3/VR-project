...
wsc.onmessage = function (evt) {
  ...
  if (!peerConn) answerCall();
   ...
   pc2.onicecandidate = onIceCandidateHandler;
    ...
    aPromise = pc2.setRemoteDescription(new RTCSessionDescription(signal.sdp)).then(function(){console.log("Hey I am here")});
  }
  else if (signal.candidate) {
    console.log("Received ICECandidate from remote peer.");
     if(!pc2 || !pc2.remoteDescription.type){
       console.log("Received remote peer."); 
       pc2.addIceCandidate(new RTCIceCandidate(signal.candidate));
    }
